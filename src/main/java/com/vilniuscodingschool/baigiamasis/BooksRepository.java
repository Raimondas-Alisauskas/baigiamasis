...
class BooksRepository {
    ...
    List<BooksDescription> BooksCatalogue() {
        ...
        book.add(new BooksDescription(2, "Pranas Kūris", "Misija ...(ne)kasdieniška diplomato kasdienybė... ", "9789986868644", "Santara", "LT", "Dalykinė", 4, 1));
        ...
        book.add(new BooksDescription(7, "Alain De Botton ", "The Art of Travel", "9780375725340", "Vintage", "EN", "Kelionės", 7, 1));
